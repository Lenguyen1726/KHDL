...
OUTPUT_DIR = BASE_DIR / "dataSet_kaggle_processed"
...
# Lần đầu nên để 500 cho chạy nhanh.
# Sau khi train ổn có thể tăng lên 1500 hoặc None.
...
def main():
    if not RAW_DIR.exists():
        ...
        print("Bạn kiểm tra lại đường dẫn kaggle_data.")
        return
    ...
    print("\n==============================")
    print("HOÀN THÀNH XỬ LÝ DATASET KAGGLE")
    print("==============================")
